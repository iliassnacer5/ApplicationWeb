package ma.emsig2.applicationweb.jsf; // Assurez-vous d'ajuster le package
...
import ma.emsig2.applicationweb.llm.LlmClient;
import ma.emsig2.applicationweb.websocket.ChatEndpoint;
...
public class Bb implements Serializable {
    ...
    public String envoyer() {
        ...
        try {
            ...
            ChatEndpoint.broadcast("== User:\n" + question + "\n== Assistant:\n" + reponse);
        } catch (Exception e) {
            this.reponse = "ERREUR LORS DE L'APPEL AU LLM : " + e.getMessage();
            FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erreur LLM", this.reponse);
            facesContext.addMessage(null, message);
        }
